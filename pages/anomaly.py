...
def layout():
    ...
    anomaly_scatter = get_anomaly_scatter()
    # anomaly_method_counts = get_anomaly_method_counts()
    anomaly_categories = get_anomaly_categories()
    # anomaly_feature_difference = get_anomaly_feature_difference()
    top10_anomalies = get_top10_anomalies()
    # cluster_anomaly_cross_reference = get_cluster_anomaly_cross_reference()
